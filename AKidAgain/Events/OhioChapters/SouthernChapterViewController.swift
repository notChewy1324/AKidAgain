//
//  SouthernChapterViewController.swift
//  AKidAgain
//
...
class SouthernChapterViewController: UIViewController {
    ...
    func updateViewWithRCValues(){
        ...
        let eventName = RemoteConfig.remoteConfig().configValue(forKey: "SouthernOhioChapterEvent").stringValue ?? ""
        label.text = (eventName)
    }
    
    func setupRemoteConfigDefaults(){
        let defaultValues = [
            "SouthernOhioChapterEvent" : "Loading..." as NSObject
        ]
